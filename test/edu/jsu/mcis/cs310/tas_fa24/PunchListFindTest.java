...
public class PunchListFindTest {
    ...
    public void testFindPunchList4() {
        ...
        LocalDate ts = LocalDate.of(2018, Month.SEPTEMBER, 5);
        LocalDate ts2 = LocalDate.of(2018, Month.SEPTEMBER, 6);
    ...
    public void testFindPunchList5() {
        ...
        LocalDate ts2 = LocalDate.of(2018, Month.SEPTEMBER, 19);

        Badge b = badgeDAO.find("BD9BB983");
        ...
        /* Add Punches */
        p2.add(punchDAO.find(4899));
        p2.add(punchDAO.find(4982));
        p2.add(punchDAO.find(5043));
        p2.add(punchDAO.find(5138));
