...
public class ShiftFindTest {
    ...
    public void testFindShiftByBadge3() {
        ...
        Badge b1 = badgeDAO.find("55BAF4B1");
        Badge b2 = badgeDAO.find("CF697DE6");
        Badge b3 = badgeDAO.find("E6386C7C");
    ...
    @Test
    public void testFindShiftByBadge4() {
        ...
        Badge b1 = badgeDAO.find("021890C0");
        Badge b2 = badgeDAO.find("0FFA272B");
        Badge b3 = badgeDAO.find("2986FF85");
