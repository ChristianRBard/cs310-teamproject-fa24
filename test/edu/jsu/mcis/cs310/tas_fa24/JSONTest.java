...
public class JSONTest {
    ...
    @Test
    public void testJSONShiftNewTest1() {
        ...
        try {
            ...
            /* Expected JSON Data */
            String expectedJSON = "[{\"originaltimestamp\":\"FRI 08\\/17\\/2018 06:54:19\",\"badgeid\":\"935B799E\",\"adjustedtimestamp\":\"FRI 08\\/17\\/2018 07:00:00\",\"adjustmenttype\":\"Shift Start\",\"terminalid\":\"101\",\"id\":\"1690\",\"punchtype\":\"CLOCK IN\"},{\"originaltimestamp\":\"FRI 08\\/17\\/2018 13:31:20\",\"badgeid\":\"935B799E\",\"adjustedtimestamp\":\"FRI 08\\/17\\/2018 13:30:00\",\"adjustmenttype\":\"Interval Round\",\"terminalid\":\"101\",\"id\":\"1740\",\"punchtype\":\"CLOCK OUT\"}]";

            ArrayList<HashMap<String, String>> expected = (ArrayList) Jsoner.deserialize(expectedJSON);

            /* Get Punch/Badge/Shift Objects */
            Punch p = punchDAO.find(1740);
            Badge b = badgeDAO.find(p.getBadge().getId());
            Shift s = shiftDAO.find(b);
    ...
    @Test
    public void testJSONShiftNewTest2() {
        ...
        try {
            ...
            /* Expected JSON Data */
            String expectedJSON = "[{\"originaltimestamp\":\"MON 08\\/13\\/2018 12:00:00\",\"badgeid\":\"8E5F0240\",\"adjustedtimestamp\":\"MON 08\\/13\\/2018 12:00:00\",\"adjustmenttype\":\"None\",\"terminalid\":\"0\",\"id\":\"1233\",\"punchtype\":\"CLOCK IN\"},{\"originaltimestamp\":\"MON 08\\/13\\/2018 20:30:00\",\"badgeid\":\"8E5F0240\",\"adjustedtimestamp\":\"MON 08\\/13\\/2018 20:30:00\",\"adjustmenttype\":\"None\",\"terminalid\":\"0\",\"id\":\"1352\",\"punchtype\":\"CLOCK OUT\"}]";

            ArrayList<HashMap<String, String>> expected = (ArrayList) Jsoner.deserialize(expectedJSON);

            /* Get Punch/Badge/Shift Objects */
            Punch p = punchDAO.find(1352);
            Badge b = badgeDAO.find(p.getBadge().getId());
            Shift s = shiftDAO.find(b);
